...
useEffect(() => {
    ...
    return (
        <tr>
            <td > 
                <input readOnly type = "text" required placeholder=" Edit Product Name" name = "name"  value= {editFormData.name}>
                    </input> 
                    </td>
                    <td > 
                <input type = "text" required placeholder=" Edit Product Quantity" name="quantity" onChange={handleEditFormChange} value= {editFormData.quantity}>
                    </input> 
                    </td>
                    <td > 
                    <Form.Control 
